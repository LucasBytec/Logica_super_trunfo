...
int main(){
    //variável do menu
    int atributo, atributo2, SomaC1_Atb1, SomaC2_Atb1, SomaC1_Atb2, SomaC2_Atb2;
    float res1, res2;
    ...
    //checa se o segundo atributo é o mesmo que foi selecionado anteriormente e pede para que selecione outro atributo
    if(atributo == atributo2){
        printf("escolha um atributo diferente do selecionado anteriormente\n");
        scanf(" %i", &atributo2);
    }
   ...
   case 2:
       ...
       printf("Carta 2: %s - População - %li\n", cidade2, populacao2);
        ...
        SomaC1_Atb1 = populacao1;
        SomaC2_Atb1 = populacao2;
   ...
   case 3:
       ...
       printf("Carta 2: %s - Área - %.2f\n", cidade2, area2);
        ...
        SomaC1_Atb1 = (float) area1;
        SomaC2_Atb1 = (float) area2;
   ...
   case 4: 
       ...
       printf("Carta 2: %s - PIB - %.2f\n", cidade2, pib2);
        ...
        SomaC1_Atb1 = (float) pib1;
        SomaC2_Atb1 = (float) pib2;
       break;    
   case 5:
       //apresentando informações das cartas
       ...
       printf("Carta 2: %s - Pontos Turísticos - %i\n", cidade2, Pturistico2);
        ...
        SomaC1_Atb1 = Pturistico1;
        SomaC2_Atb1 = Pturistico2;
       break;
   case 6:
       ...
       printf("Carta 2: %s - População - %.2f\n", cidade2, densidade2);
        ...
        SomaC1_Atb1 = (float) densidade1;
        SomaC2_Atb1 = (float) densidade2;
       break;
   default:
   ...
   case 2:
       ...
       printf("Carta 2: %s - População - %li\n", cidade2, populacao2);
        ...
        SomaC1_Atb2 = populacao1;
        SomaC2_Atb2 = populacao2;
   ...
   case 3:
       ...
       printf("Carta 2: %s - Área - %.2f\n", cidade2, area2);
        ...
        SomaC1_Atb2 = (float) area1;
        SomaC2_Atb2 = (float) area2;
       break;         
   case 4: 
       //apresentando informações das cartas
       printf("\nAtributo escolhido: 'PIB'\n");
       ...
       printf("Carta 2: %s - PIB - %.2f\n", cidade2, pib2);
        ...
        SomaC1_Atb2 = (float) pib1;
        SomaC2_Atb2 = (float) pib2;
       break;    
   case 5:
       //apresentando informações das cartas
       printf("\nAtributo escolhido: 'Pontos Turísticos'\n");
       ...
       printf("Carta 2: %s - Pontos Turísticos - %i\n", cidade2, Pturistico2);
        ...
        SomaC1_Atb2 = Pturistico1;
        SomaC2_Atb2 = Pturistico2;
        break;
   case 6:
       printf("\nAtributo escolhido: 'Densidade'\n");
       printf("Carta 1: %s - População - %.2f\n", cidade1, densidade1);
       printf("Carta 2: %s - População - %.2f\n", cidade2, densidade2);
        ...
        SomaC1_Atb2 = (float) densidade1;
        SomaC2_Atb2 = (float) densidade2;
        break;
   default:
           printf("opção inválida");

    }
    printf("\nsomando valores dos atributos...\n");
    res1 = SomaC1_Atb1 + SomaC1_Atb2;
    res2 = SomaC2_Atb1 + SomaC2_Atb2;

    if (res1 > res2){
        printf("\nCarta 1 vence com %.2f\n", res1);
    } else if(res1 == res2) {
        printf("\nEMPATE!\n");
    } else {
        printf("\nCarta 2 vence com %.2f\n", res2);
    }
